...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir");
        String originProjectPath = new File(projectPath).getParent() + File.separator + "yang-generator-demo-projects/acm-template";
        String inputFilePath = "src/com/yang/acm/MainTemplate.java";
...
//        modelInfo.setDefaultValue("sum = ");
      ...
      // String searchStr = "Sum: ";
        ...
        long id = makeTemplate(meta, originProjectPath, inputFilePath, modelInfo, searchStr, 1965328107019874304L);
