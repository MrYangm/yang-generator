...
import com.yang.maker.template.model.TemplateMakerFileConfig;
import com.yang.maker.template.model.TemplateMakerModelConfig;
...
public class TemplateMaker {
    ...
    public static long makeTemplate(Meta newMeta, String originProjectPath, TemplateMakerFileConfig templateMakerFileConfig, TemplateMakerModelConfig templateMakerModelConfig, Long id) {
        ...
        if (modelGroupConfig != null) {
            Meta.ModelConfig.ModelInfo groupModelInfo = getModelInfo(modelGroupConfig, inputModelInfoList);
    ...
    private static Meta.ModelConfig.ModelInfo getModelInfo(TemplateMakerModelConfig.ModelGroupConfig modelGroupConfig, List<Meta.ModelConfig.ModelInfo> inputModelInfoList) {
...
//        String searchStr = "Sum: ";
    ...
    private static TemplateMakerModelConfig getTemplateMakerModelConfig() {
        ...
        // - 模型配置
        List<TemplateMakerModelConfig.ModelInfoConfig> modelInfoConfigList = getModelInfoConfigs();
        templateMakerModelConfig.setModels(modelInfoConfigList);
        return templateMakerModelConfig;
    }

    private static List<TemplateMakerModelConfig.ModelInfoConfig> getModelInfoConfigs() {
        ...
        return Arrays.asList(modelInfoConfig1, modelInfoConfig2);
    }
