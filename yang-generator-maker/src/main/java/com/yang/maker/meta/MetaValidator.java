...
import com.yang.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    private static void validAndFillFileConfig(Meta meta) {
        ...
        // inputRootPath: 默认值 .source/{sourceRootPath最后一部分}
        ...
        // outputRootPath: 默认值 generated/{name}
    ...
    private static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "yang");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.yang");
